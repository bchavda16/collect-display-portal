...
export default function AccountPage() {
  ...
  const S: any = {
    ...
    tab: (a:boolean) => ({padding:"10px 18px",fontSize:13,fontWeight:a?600:500,color:a?"#F0A3BC":"#8888AA",background:"none",border:"none",cursor:"pointer",borderBottom:"2px solid",borderBottomColor:a?"#F0A3BC":"transparent",marginBottom:-2}),
    ...
    fg: {marginBottom:14},
    btnPink: {display:"inline-flex",alignItems:"center",padding:"8px 16px",background:"#F0A3BC",color:"white",border:"none",borderRadius:8,fontSize:13,fontWeight:600,cursor:"pointer"},
